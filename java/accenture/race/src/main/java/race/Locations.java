...
class Locations {
    ...
    static Location HAMILTON() {
        return new Location(new PointImpl(-64.783, 32.295, SpatialContext.GEO), ZoneId.of("Europe/Stockholm"));
    }

    static Location CAPE_HORN() {
        return new Location(new PointImpl(-67.270, -55.974, SpatialContext.GEO), ZoneId.of("Europe/Stockholm"));
    }
