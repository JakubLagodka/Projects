package it.unipol.crm.anagrafica.gestione.client.sts.exception;
...
public class StsFeignException extends RuntimeException{
    ...
    public StsFeignException(String message, String requestId, Integer statusFromFeignClient,
