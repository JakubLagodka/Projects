...
import it.unipol.crm.anagrafica.gestione.service.entities.UplCrmNucleiDettPersistenceService;
...
public class UplCrmNucleiDettPersistenceServiceTest {
    @Autowired
    private UplCrmNucleiDettPersistenceService service;
    private UplCrmNucleiDett populateUplCrmNucleiDett(UplCrmNucleiDett nuclei) {
        Timestamp timestamp = Timestamp.valueOf("2022-08-10 12:00:00.000");
        nuclei.setUtenteInserimento("");
        nuclei.setDataInizio(timestamp);
        nuclei.setIdSoggetto(BigInteger.TEN);
        nuclei.setIdnucleo(BigInteger.TEN);
    ...
    void shouldGenerateDefaultValues() {
        //given
        UplCrmNucleiDett nuclei = populateUplCrmNucleiDett(new UplCrmNucleiDett());

        //when
        final UplCrmNucleiDett inserted = service.insertNucleiDett(nuclei);
