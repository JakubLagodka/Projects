package pl.lagodka.webapp.web.rest;
...
import static pl.lagodka.webapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import pl.lagodka.webapp.IntegrationTest;
import pl.lagodka.webapp.config.Constants;
import pl.lagodka.webapp.domain.PersistentToken;
import pl.lagodka.webapp.domain.User;
import pl.lagodka.webapp.repository.AuthorityRepository;
import pl.lagodka.webapp.repository.PersistentTokenRepository;
import pl.lagodka.webapp.repository.UserRepository;
import pl.lagodka.webapp.security.AuthoritiesConstants;
import pl.lagodka.webapp.service.UserService;
import pl.lagodka.webapp.service.dto.AdminUserDTO;
import pl.lagodka.webapp.service.dto.PasswordChangeDTO;
import pl.lagodka.webapp.service.dto.UserDTO;
import pl.lagodka.webapp.web.rest.vm.KeyAndPasswordVM;
import pl.lagodka.webapp.web.rest.vm.ManagedUserVM;
