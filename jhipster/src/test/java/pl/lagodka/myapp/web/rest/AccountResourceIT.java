...
import static pl.lagodka.myapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import pl.lagodka.myapp.IntegrationTest;
import pl.lagodka.myapp.config.Constants;
import pl.lagodka.myapp.domain.PersistentToken;
import pl.lagodka.myapp.domain.User;
import pl.lagodka.myapp.repository.AuthorityRepository;
import pl.lagodka.myapp.repository.PersistentTokenRepository;
import pl.lagodka.myapp.repository.UserRepository;
import pl.lagodka.myapp.security.AuthoritiesConstants;
import pl.lagodka.myapp.service.UserService;
import pl.lagodka.myapp.service.dto.AdminUserDTO;
import pl.lagodka.myapp.service.dto.PasswordChangeDTO;
import pl.lagodka.myapp.service.dto.UserDTO;
import pl.lagodka.myapp.web.rest.vm.KeyAndPasswordVM;
import pl.lagodka.myapp.web.rest.vm.ManagedUserVM;
